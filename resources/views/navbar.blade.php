...
<style>
    ...
    * {
    ...
    .sa-nav__links {
        ...
        .sa-nav__links a:hover::after {
            right: 0;
        }

        .sa-nav__links a.active {
            color: var(--gold);
        }

        .sa-nav__links a.active::after {
            right: 0;
        }
...
<nav class="sa-nav">
    ...
    <ul class="sa-nav__links">
        ...
        <li>
            <a href="{{ route('cart.index') }}" class="cart-icon" title="Winkelwagen">
                🛒
                @php
        ...
        @auth
            ...
            <li>
                <form method="POST" action="{{ url('/logout') }}" style="display:inline;">
                    @csrf
                    <button type="submit"
                        style="background:transparent;border:none;color:rgba(245,240,232,.65);font-size:.78rem;letter-spacing:.14em;text-transform:uppercase;cursor:pointer;">Uitloggen</button>
                </form>
            </li>
        @else
